...
INSERT INTO landmark (landmark_id, title, latitude, longitude)
VALUES (1, 'Landmark1', 37.566535, 126.977969),
       (2, 'Landmark2', 37.551229, 126.988205),
       (3, 'Landmark3', 37.579617, 126.977041);


INSERT INTO landmark_song (landmark_song_id, landmark_id, song_id, user_id, representative_img, created_date,
                           modified_date)
VALUES (1, 1, 1, 1, 'test1', NOW(), NOW()),
       (2, 1, 2, 1, 'test2', NOW(), NOW()),
       (3, 2, 3, 1, 'test3', NOW(), NOW()),
       (4, 3, 1, 1, 'test4', NOW(), NOW()),
       (5, 3, 3, 1, 'test5', NOW(), NOW());
