...
VALUES (1, 'yId1', 'Title1', 'Artist1', 'AlbumImg1', 5000, NOW(), NOW()),
       (2, 'yId2', 'Title2', 'Artist2', 'AlbumImg2', 4000, NOW(), NOW()),
       (3, 'yId3', 'Title3', 'Artist3', 'AlbumImg3', 4500, NOW(), NOW());

INSERT INTO landmark (landmark_id, title, latitude, langitude, representative_img)
