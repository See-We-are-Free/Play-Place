...
public interface SongHistoryRepository extends JpaRepository<SongHistory, Long> {
    @Query(value = "SELECT * FROM (\n" +
            ...
            List<Object[]> findAreaSong(@Param("oneWeekAgo") LocalDateTime oneWeekAgo);
    ...
    @Query(value = "SELECT * FROM (\n" +
            ...
            ") as weather_song " +
            "WHERE rn <= 10;", nativeQuery = true)
    List<Object[]> findWeatherSong(@Param("oneWeekAgo") LocalDateTime oneWeekAgo);
    ...
    @Query(value = "SELECT * FROM (\n" +
            ...
            ") as timezone_song " +
            "WHERE rn <= 10;", nativeQuery = true)
    List<Object[]> findTimeZoneSong(@Param("oneWeekAgo") LocalDateTime oneWeekAgo);
